...
typedef NS_ENUM(NSInteger, WegVersionKey) {
    ...
    WegVersionKeyI_S_SEXT,
    WegVersionKeyI_S_CEXT,
    WegVersionKeySEGRN
};
...
@property (nonatomic, strong) NSMutableDictionary<NSNumber *, NSString *> *pendingVersions;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions withEventReportingStrategy:(ReportingStrategy)reportingStrategy;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions notificationDelegate:(id<WEGInAppNotificationProtocol>)notificationDelegate autoRegister:(BOOL)apnRegister setLicenseCode:(NSString *)licenseCode withEventReportingStrategy:(ReportingStrategy)reportingStrategy;
...
-(void)registerNetworkInterceptor:(id)object;
...
- (NSString *)getDeeplinkFor:(NSDictionary *)inAppNotificationData clickedWithAction:(NSString *)actionId;
